frappe.ui.form.on('Cash Payment Vouchers', {
    ...
    account: function (frm) {
        frappe.call({
            method: 'general_voucher_v2.general_voucher_v2.doctype.utils.get_account_balance',
            args: {
...
frappe.ui.form.on("Cash Payment Vouchers Items", {

    account: function (frm, cdt, cdn) {
        var d = locals[cdt][cdn];
        frappe.call({
            method: 'general_voucher_v2.general_voucher_v2.doctype.utils.get_party_type',
            args: {
                account: d.account,
            },
            callback: function (r) {
